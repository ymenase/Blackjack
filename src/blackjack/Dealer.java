...
//			dealingLogic(dealerHand, playerHand, player); //testing area
			...
			if (choice == 1) {
				...
				System.out.println(player.getName() + "'s new card: " + dc.getLastCard(playerHand));
				System.out.println(player.getName() + "'s total is " + h.getTotalOfHand(playerHand));
//				dealingLogic(dealerHand, playerHand, player);
			...
			if (choice ==2) {
				...
				while (h.getTotalOfHand(dealerHand) < 17) {
					...
					System.out.println("Dealer's new card: " + dc.getLastCard(dealerHand));
